...
abstract class ArrayRules
{
    ...
    public static $columns = array(
        ...
        'linked_domains_by_type' => array(
            'domain_from' => array('string', false, true),
            'domain_to' => array('string', false, true),
            'links' => array('int', false, true),
            'all' => array('int', false, true),
            'text' => array('int', false, true),
            'image' => array('int', false, true),
            'nofollow' => array('int', false, true),
            'dofollow' => array('int', false, true),
            'redirect' => array('int', false, true),
            'canonical' => array('int', false, true),
            'gov' => array('int', false, true),
            'edu' => array('int', false, true),
            'rss' => array('int', false, true),
            'alternate' => array('int', false, true),
            'first_seen' => array('date', true, true),
            'last_visited' => array('date', true, true),
            'domain_to_rating' => array('int', false, true),
            'domain_to_ahrefs_top' => array('int', false, true),
        ),
        'metrics' => array(
